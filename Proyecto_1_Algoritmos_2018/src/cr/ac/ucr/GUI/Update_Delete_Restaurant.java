 ...
 * @author Melvin
 */
public class Update_Delete_Restaurant extends javax.swing.JFrame {

    /**
     * Creates new form Update_Delete_Restaurant
     */
    public Update_Delete_Restaurant() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Delete_Restaurant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_Delete_Restaurant().setVisible(true);
            }
        });
    }
